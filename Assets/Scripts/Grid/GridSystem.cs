...
public class GridSystem<TGridObject>
{
    ...
    public GridSystem(int widht, int height, float cellSize, Func<GridSystem<TGridObject>, GridPosition, TGridObject> createGridObject) {
        this.width = widht;
        this.height = height;
    ...
    public void CreateDebugObjects(Transform debugPrefab)
    {
        for (int x = 0; x < width; x++)
        {
            for (int z = 0; z < height; z++)
            {
                ...
                gridDebugObject.SetGridObejct(GetGridObject(gridPosition) as GridObject);
